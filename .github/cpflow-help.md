...
[CI automation guide](https://github.com/shakacode/control-plane-flow/blob/v6.0.0.rc.0/docs/ci-automation.md).
...
example `v6.0.0.rc.0`. Before review and merge, use the pin
